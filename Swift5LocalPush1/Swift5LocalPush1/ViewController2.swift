...
class ViewController2: UIViewController {
    ...
    func timerUpdate(){
        ...
        let trigger1 = UNTimeIntervalNotificationTrigger(timeInterval: 5
            , repeats: false)
        ...
        let trigger2 = UNTimeIntervalNotificationTrigger(timeInterval: 8
            , repeats: false)
        ...
        let trigger3 = UNTimeIntervalNotificationTrigger(timeInterval: 11
            , repeats: false)
        ...
        let trigger4 = UNTimeIntervalNotificationTrigger(timeInterval: 14
            , repeats: false)
